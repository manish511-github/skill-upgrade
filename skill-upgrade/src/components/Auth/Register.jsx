    ...
    <Container h={'95vh'}>
        ...
        <form onSubmit={submitHandler} style={{ width: '100%' }}>
            ...
            <Box my={'4'}>
                ...
                <Input required id="password" value={password} onChange={e=>setPassword(e.target.value)} placeholder="Enter Your Password" type={'password'} focusBorderColor="yellow.500"></Input>
            </Box>
            <Box my={'4'}>
                <FormLabel htmlFor='chooseAvatar' children="Choose Avatar"></FormLabel>
                <Input   accept="image/*" required id="chooseAvatar" type={'file'} onChange={changeImageHandler}   css={fileUploadStyle} ></Input>
            </Box>
